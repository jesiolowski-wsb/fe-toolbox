        ...
        switch ((t.call(Wf, e), e.type)) {
          ...
          default:
            ...
            Wf.defaults.extensions.childTokens[e.type]
              ? Wf.defaults.extensions.childTokens[e.type].forEach(function (
                  n
                ) {
                  Wf.walkTokens(e[n], t);
                })
      ...
      return (
        ...
        !0 === a &&
          (o.listitem = function (e) {
            return '<li class="fragment">'.concat(e, "</small></li>");
          }),
        Wf.setOptions(
          (function (t) {
